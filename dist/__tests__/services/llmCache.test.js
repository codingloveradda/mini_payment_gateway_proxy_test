...
describe('LLM Cache Service', () => {
    ...
    describe('generateCacheKey', () => {
        it('should generate consistent keys for similar transactions', () => {
            ...
            const key1 = llmCache_1.llmCache.generateCacheKey(factors1);
            const key2 = llmCache_1.llmCache.generateCacheKey(factors2);
    ...
    describe('get and set', () => {
        it('should store and retrieve cached explanations', () => {
            ...
            llmCache_1.llmCache.set(key, explanation);
            const retrieved = llmCache_1.llmCache.get(key);
            expect(retrieved).toBe(explanation);
        });
        it('should return null for non-existent keys', () => {
            const retrieved = llmCache_1.llmCache.get('non_existent_key');
        ...
        it('should handle cache expiration', (done) => {
            ...
            llmCache_1.llmCache.set(key, explanation, 1);
            // Wait for expiration
            setTimeout(() => {
                const retrieved = llmCache_1.llmCache.get(key);
                expect(retrieved).toBeNull();
    ...
    describe('getStats', () => {
        it('should return correct statistics', () => {
            const stats = llmCache_1.llmCache.getStats();
